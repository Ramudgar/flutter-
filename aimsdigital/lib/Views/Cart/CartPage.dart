...
class WithoutCourses extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CourseBloc, CourseState>(
        builder: (_, state) => (state.courses == null ||
            ...
            ? Container(
                ...
                child: Column(
                  children: [
                    ...
                    CustomText(
                        text:
                            'Currently do not have any Courses in your Purchases cart',
                        fontSize: 16),
                    SizedBox(height: 20),
                    Padding(
                      ...
                      child: TextButton(
                        ...
                        child: CustomText(text: 'Go Courses', fontSize: 10.h),
